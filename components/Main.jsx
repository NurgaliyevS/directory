...
export default function Main() {
  ...
  return (
    <section className="container max-w-6xl mx-auto flex flex-col px-4 sm:px-8 p-2 lg:p-6 my-2 items-center justify-center">
      <div className="flex flex-col gap-6 sm:gap-10 lg:gap-12 mb-6 sm:mb-10">
        ...
        <p className="text-base sm:text-lg text-base-content-secondary leading-relaxed max-w-md text-center">
          Apply now
        </p>
      </div>
